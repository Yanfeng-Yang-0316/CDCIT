...
👊😁🔥**2025.6.30, DDIM sampler is updated to highdim_XY.ipynb, diffusion_crt.py and model.py! Now you can use the faster DDIM sampler for simulations. In my PC, the time required by DDIM is about 1/6 of DDPM!**
